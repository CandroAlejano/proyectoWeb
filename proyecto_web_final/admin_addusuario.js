...
document
  ...
  .addEventListener("submit", function (event) {
    ...
    cell2.classList.add('apellido');
    var cell3 = newRow.insertCell(2);
    cell3.classList.add('dni');
    var cell4 = newRow.insertCell(3);
    cell4.classList.add('correo');
    var cell5 = newRow.insertCell(4);
    cell5.classList.add('departamento');
...
document
  ...
  .addEventListener("submit", function (event) {
    ...
    cell2.classList.add('apellido');
    var cell3 = newRow.insertCell(2);
    cell3.classList.add('nia');
    var cell4 = newRow.insertCell(3);
    cell4.classList.add('correo');
    var cell5 = newRow.insertCell(4);
    cell5.classList.add('curso');
